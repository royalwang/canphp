  ...
  <table cellpadding="0" cellspacing="1" class="table_form">
    ...
    <tr>
      ...
      <td>
		...
		<input type="button" value="显示/隐藏关键词和摘要" onClick="hide()">
		</td>
    </tr>
    <tr id="tr_keywords" style="display:none">
      <th width="20%"> <strong>关键词</strong> <br />
        多关键词之间用空格隔开 </th>
      <td><input name="keywords" type="text" class="" id="keywords" value="" size="100" maxlength="255"  /></td>
    </tr>
    <tr id="tr_description" style="display:none">
      ...
      <td><img src="__PUBLIC__/images/right2/icon.gif" width="12" height="12"> 还可以输入 <font id="ls_description" color="#ff0000;">255</font> 个字符！<br />
        <textarea name="description" id="description" rows="4" cols="50" class="" style="width:80%" onKeyUp="check_length();"></textarea>      </td>
    </tr>
    <tr>
      <th width="20%"> <font color="red">*</font> <strong>内容</strong> <br />        </th>
      <td><textarea name="content" id="content" style=" width:700px;height:450px;visibility:hidden;"></textarea></td>
    </tr>
    <tr>
