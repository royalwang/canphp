...
<form action="__URL__/add" method="post" enctype="multipart/form-data">
  ...
  <tr>
      ...
      <td width="70%">	    
			<textarea name="intro" cols="58" rows="5"></textarea>
	  </td>
    </tr>
    <tr>
      <th width="30%" class="align_c"><strong>案例图片</strong></th>
      <td width="70%"><input name="image" type="file" size="60"></td>
    </tr>
     <tr>
      <th width="30%" class="align_c"><strong>链接地址 </strong></th>
      <td width="70%"><input name="url" type="text"  size="60">(可选)</td>
    </tr>
    <tr>
