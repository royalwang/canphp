<?php if (!defined('CANPHP')) exit;?><div class="install_right">
 <form action="<?php echo url('index/db');?>" method="post" >
  <div class="install_box">
    ...
    <div class="install_btn">
      <input class="button" value="上一步" type="button" onClick="window.location.href = '<?php echo url('index/env');?>'">
