...
<body>
<div class="df_main">
  <div class="df_title">CPAPP<span>{$hello}</span></div>
  <div class="df_intro">
    <h3>CPAPP简介：</h3>
	...
	<div class="clear"></div>
    <div class="button"><a href="http://www.canphp.com">进入CP官网</a> <a href="{url('admin/index/index')}">点击进入后台</a> <span>(后台默认用户名admin 密码123456)</span></div>
    <div class="clear"></div>
  </div>
