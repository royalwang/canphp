...
if( isset($GLOBALS['app_id']) && isset($GLOBALS['xhprof']) && $GLOBALS['xhprof'] >0 ) {
	$is_remote = isset($GLOBALS['xhprof_remote']) ? $GLOBALS['xhprof_remote'] : true;
	obj('dwXhprof')->enable($GLOBALS['app_id'], $GLOBALS['xhprof'], $is_remote);
}
